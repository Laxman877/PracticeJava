...
<div id="login-box">
 ...
 <form:form action="reguser" modelAttribute="userreg" method="post" enctype="multipart/form-data">
  ...
  <div class="right">
    ...
    <button class="social-signin twitter"><a href="userlog">Login User</a></button>
  </div>
